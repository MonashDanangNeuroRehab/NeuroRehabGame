...
namespace Packages.Rider.Editor.ProjectGeneration
{
  internal class ProjectGeneration : IGenerator
  {
    ...
    public bool SyncIfNeeded(IEnumerable<string> affectedFiles, IEnumerable<string> reimportedFiles)
    {
      ...
      {
        Sync();
<<<<<<<< Updated upstream:Library/PackageCache/com.unity.ide.rider@2.0.7/Rider/Editor/ProjectGeneration/ProjectGeneration.cs
        RiderScriptEditorData.instance.hasChanges = false;
========
>>>>>>>> Stashed changes:Library/PackageCache/com.unity.ide.rider@3.0.18/Rider/Editor/ProjectGeneration/ProjectGeneration.cs
        return true;
      }
